...
* Description: Student tests to test the features of the order class. 
* Due: 08/05/2024
...
public class OrderTestStudent {
	...
	public void testAddNewBeverage() throws NullPointerException {
		...
		assertTrue(orderOne.getNumItems() == 0);
		orderOne.addNewBeverage("regular Coffee", Size.SMALL, false, false);
		...
		assertTrue(orderOne.getNumItems() == 3);
		...
		assertTrue(orderTwo.getNumItems() == 3);
